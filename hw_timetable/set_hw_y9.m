...
%% Find HIS occurences
idx1 = find(strcmp(form_1.subjects.id,'HIS')==1);
idx2 = find(strcmp(form_2.subjects.id,'HIS')==1);
idx3 = find(strcmp(form_3.subjects.id,'HIS')==1);
idx4 = find(strcmp(form_4.subjects.id,'HIS')==1);

count_his_1 = find_sub_occurr(soln_1,form_1,idx1)
count_his1_2 = find_sub_occurr(soln_2,form_2,idx2)
count_his1_3 = find_sub_occurr(soln_3,form_3,idx3)
count_his1_4 = find_sub_occurr(soln_4,form_4,idx4)
% 
